...
import com.mobilitychina.people.weiget.SimpleMessageItem;
...
//		HttpPostService.switchServer(isMainServer);
	...
	*//**
	 ...
	 * @return
	 */
	public static String formatToDayChina() {
	...
	public static String getTimeTurn(String s1){
		double s = Double.valueOf(s1);
		 int hour = (int) s;
		 java.text.DecimalFormat   df=new   java.text.DecimalFormat("0");   
		 int min = (int) ((s-hour)*60);
		 String mins =  df.format(min);
		 if(mins.length()==1){
			 mins= "0"+mins;
		 }
