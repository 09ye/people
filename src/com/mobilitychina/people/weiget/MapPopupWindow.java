package com.mobilitychina.people.weiget;
...
public class MapPopupWindow implements OnItemClickListener {
	...
	private MapPopupWindow.OnItemClickListener listener;

	public MapPopupWindow(Context context, List<String> data) {
